// Command server runs the Indicator Management service HTTP API and Kafka
// producer.
package main
...
import (
	...
	"github.com/siberindo/cti/services/indicator-service/internal/api"
	"github.com/siberindo/cti/services/indicator-service/internal/config"
...
func main() {
	...
	log.Info("indicator-service starting", slog.Int("port", cfg.HTTPPort), slog.String("env", cfg.Env))
