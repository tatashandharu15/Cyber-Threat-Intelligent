// Command server runs the CLM (Credential Leak Monitoring) service HTTP API and
// Kafka producer.
package main
...
import (
	...
	"github.com/siberindo/cti/services/clm-service/internal/api"
	"github.com/siberindo/cti/services/clm-service/internal/config"
...
func main() {
	...
	log.Info("clm-service starting", slog.Int("port", cfg.HTTPPort), slog.String("env", cfg.Env))
