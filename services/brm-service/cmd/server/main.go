// Command server runs the BRM (Brand Monitoring) service HTTP API and Kafka
// producer.
package main
...
import (
	...
	"github.com/siberindo/cti/services/brm-service/internal/api"
	"github.com/siberindo/cti/services/brm-service/internal/config"
...
func main() {
	...
	log.Info("brm-service starting", slog.Int("port", cfg.HTTPPort), slog.String("env", cfg.Env))
