// Command server runs the DWM (Dark Web Monitoring) service HTTP API and Kafka
// producer.
package main
...
import (
	...
	"github.com/siberindo/cti/services/dwm-service/internal/api"
	"github.com/siberindo/cti/services/dwm-service/internal/config"
...
func main() {
	...
	log.Info("dwm-service starting", slog.Int("port", cfg.HTTPPort), slog.String("env", cfg.Env))
