// Command server runs the Takedown service HTTP API and Kafka producer.
package main
...
import (
	...
	"github.com/siberindo/cti/services/takedown-service/internal/api"
	"github.com/siberindo/cti/services/takedown-service/internal/config"
...
func main() {
	...
	log.Info("takedown-service starting", slog.Int("port", cfg.HTTPPort), slog.String("env", cfg.Env))
