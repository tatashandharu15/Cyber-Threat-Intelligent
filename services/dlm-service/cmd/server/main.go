// Command server runs the DLM (Data Leak Monitoring) service HTTP API and Kafka
// producer.
package main
...
import (
	...
	"github.com/siberindo/cti/services/dlm-service/internal/api"
	"github.com/siberindo/cti/services/dlm-service/internal/config"
...
func main() {
	...
	log.Info("dlm-service starting", slog.Int("port", cfg.HTTPPort), slog.String("env", cfg.Env))
