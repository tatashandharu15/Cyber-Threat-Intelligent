// Command server runs the Auth service HTTP API.
package main
...
import (
	...
	"github.com/siberindo/cti/services/auth-service/internal/api"
	"github.com/siberindo/cti/services/auth-service/internal/config"
...
func main() {
	...
	svc := service.New(st, issuer, cfg.TokenTTL)
	...
	log.Info("auth-service starting", slog.Int("port", cfg.HTTPPort), slog.String("env", cfg.Env))
